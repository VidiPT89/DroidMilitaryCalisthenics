...
private val strings: Map<String, Pair<String, String>> = mapOf(
    ...
    "Leg Swings" to ("Balanço de Pernas" to "Leg Swings"),
    "Squats" to ("Agachamentos" to "Squats"),
    ...
    "Diamond Push-ups" to ("Flexões Diamante" to "Diamond Push-ups"),
    "Pull-ups" to ("Dominadas" to "Pull-ups"),
    "Chin-ups" to ("Dominadas Supinadas" to "Chin-ups"),
    "Negative Pull-ups" to ("Negativas na Barra" to "Negative Pull-ups"),
    "Hanging Leg Raises" to ("Elevação de Pernas Suspenso" to "Hanging Leg Raises"),
    "Inverted Rows (table)" to ("Remada Invertida (mesa)" to "Inverted Rows (table)"),
    "Dips" to ("Fundos em Paralelas" to "Dips"),
    "L-sit" to ("L-sit" to "L-sit"),
    ...
    "Sprints" to ("Sprints" to "Sprints"),
    "High Knees" to ("Joelhos Altos" to "High Knees"),
    "High Knees (circuit)" to ("Joelhos Altos (circuito)" to "High Knees (circuit)"),
    ...
    "Leg Raises (floor)" to ("Elevação de Pernas (chão)" to "Leg Raises (floor)"),
    ...
    "Quad Stretch" to ("Alongamento Quadricípete" to "Quad Stretch"),
    "Child's Pose" to ("Postura da Criança" to "Child's Pose")
)
